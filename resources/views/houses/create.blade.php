<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create House</h2>
    </x-slot>
                ...
                <form action="{{ route('houses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="house_number" value="{{ old('house_number') }}" class="mt-1 block w-full rounded-md border-gray-300" required>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" min="0" name="rent" value="{{ old('rent') }}" class="mt-1 block w-full rounded-md border-gray-300" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="house_type" value="{{ old('house_type') }}" class="mt-1 block w-full rounded-md border-gray-300" required>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <select name="landlord_id" class="mt-1 block w-full rounded-md border-gray-300">
                                    ...
                                    @foreach ($landlords as $landlord)
                                        <option value="{{ $landlord->id }}" @selected(old('landlord_id') == $landlord->id)>{{ $landlord->full_name }} ({{ $landlord->email }})</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="flex items-center gap-3">
                        <button class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700" type="submit">Save House</button>
